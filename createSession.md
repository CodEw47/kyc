...
AWS_PROFILE=admin aws amplify update-branch --region us-east-2 --app-id d1ougq7j1szw3s --branch-name main --environment-variables "KYC_ALLOWED_API_KEYS=test\,test1,KYC_AWS_ACCESS_KEY_ID=SEU_KEY,KYC_AWS_SECRET_ACCESS_KEY=SEU_SECRET,KYC_AWS_REGION=us-east-1"